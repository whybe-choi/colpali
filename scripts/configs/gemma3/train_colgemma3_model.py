"""
ColGemma3 Korean VDR Training Script

Base model: google/gemma-3-4b-it (4.36B params)
Training data: ko-vdr-train-public-v1.0 + ko-vdr-train-private-v0.1
...
Usage:
    ...
    --output-dir ./outputs/colgemma3-ko-run4 \
    --run-name colgemma3-ko-run4 \
...
def parse_args():
    ...
    # Model
    p.add_argument("--model-name-or-path", type=str, default="./models/base_models/colgemma3-base")
