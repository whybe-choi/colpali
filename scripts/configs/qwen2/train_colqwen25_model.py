"""
ColQwen2.5 Korean VDR Training Script

Base model: Qwen/Qwen2.5-VL (via colqwen2.5-base)
...
Usage:
    ...
    --output-dir ./outputs/colqwen25-ko-run1 \
    --run-name colqwen25-ko-run1 \
...
def parse_args():
    ...
    # Model
    p.add_argument("--model-name-or-path", type=str, default="./models/base_models/colqwen2.5-base")
