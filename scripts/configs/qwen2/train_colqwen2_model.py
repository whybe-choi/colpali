"""
ColQwen2 Korean VDR Training Script

Base model: Qwen/Qwen2-VL (via colqwen2-base)
...
Usage:
    ...
    scripts/configs/qwen2/train_colqwen2_model.py \
    --output-dir ./outputs/colqwen2-ko-run1 \
    --run-name colqwen2-ko-run1 \
...
def parse_args():
    ...
    # Model
    p.add_argument("--model-name-or-path", type=str, default="./models/base_models/colqwen2-base")
